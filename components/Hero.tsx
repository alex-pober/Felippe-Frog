...
export function Hero() {
  return (
    <div className="relative min-h-[700px] md:min-h-[700px] overflow-hidden">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 h-full py-8">
        <div className="max-w-2xl">
          ...
          <button className="mt-6 md:mt-8 px-6 md:px-8 py-3 md:py-4 bg-green-500/80 text-white rounded-xl text-lg md:text-xl hover:bg-green-600/80 transition-colors">
            Media
          </button>
        </div>
        
        <div className="relative md:absolute right-0 top-0 md:top-1/2 md:-translate-y-1/2 z-[-1] h-[400px] md:h-full w-full md:w-auto">
          <Image
